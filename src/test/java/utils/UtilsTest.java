...
public class UtilsTest {
    ...
    private static Stream<Arguments> isItemOverlappingValues() {
        return Stream.of( // TODO: Add correct test cases
                Arguments.of(new Item(0, 1, 1), new Position(0, 0), new Item(0, 1, 1), new Position(0, 0), true),
                Arguments.of(new Item(0, 1, 1), new Position(0, 0), new Item(0, 1, 1), new Position(1, 0), false),
                Arguments.of(new Item(0, 1, 1), new Position(0, 0), new Item(0, 1, 1), new Position(0, 1), false),
                Arguments.of(new Item(0, 1, 1), new Position(0, 0), new Item(0, 1, 1), new Position(1, 1), false)
        );
    }
}
